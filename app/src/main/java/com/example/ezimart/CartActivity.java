...
public class CartActivity extends AppCompatActivity implements cartloadlistener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanBtn = findViewById(R.id.scanCartBtn);
        ...
        scanBtn.setOnClickListener(v -> {
            startActivity(new Intent(CartActivity.this, ScanShopActivity.class).putExtra("userInformation", userInformation));
            finish();
        });
...
//return cartModels;
    ...
    protected void loadCartFromFirebase(){
        ...
        FirebaseDatabase.getInstance().getReference("Cart")
                .child(userInformation.getUsername()).addListenerForSingleValueEvent(new ValueEventListener() {
