...
//        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.teal_200)));
        ...
        {
            startActivity(new Intent(ScanShopActivity.this, MainActivity.class));
            finish();
        });
...
//                                    Toast.makeText(ScanShopActivity.this,"Product doesn't exist", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }else
    ...
    private void addToCart(ItemModel itemModel) {
        ...
        userCart.child(itemModel.getKey()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    userCart.child(itemModel.getKey()).updateChildren(updateData).addOnSuccessListener(aVoid -> {
